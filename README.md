...
gsms <- paste0("00000000000XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
        "11111111111XXXXXXXXXXXXXXXXX")
...
gs <- factor(sml)
groups <- make.names(c("Control Samples","Case Samples"))
levels(gs) <- groups
gset$group <- gs
...
plotSA(fit2, main="Mean variance trend, GSE63514")
